 ...
 */
class LabeledValueAdapterDelegate : AbsListItemAdapterDelegate<LabeledValueItem, Any, LabeledValueAdapterDelegate.Holder>() {
    ...
    override fun isForViewType(item: Any, items: MutableList<Any>, position: Int): Boolean {
        return item is LabeledValueItem && item.inCard.not()
    }
