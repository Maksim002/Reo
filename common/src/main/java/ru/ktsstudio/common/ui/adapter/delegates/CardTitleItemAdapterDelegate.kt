 ...
 */
class CardTitleItemAdapterDelegate :
    AbsListItemAdapterDelegate<CardTitleItem, Any, CardTitleItemAdapterDelegate.Holder>() {

    override fun onCreateViewHolder(parent: ViewGroup): Holder {
        return parent.inflate(R.layout.item_card_title).let { Holder(it) }
    }

    override fun isForViewType(item: Any, items: MutableList<Any>, position: Int): Boolean {
        return item is CardTitleItem && item.withAccent.not()
    }
