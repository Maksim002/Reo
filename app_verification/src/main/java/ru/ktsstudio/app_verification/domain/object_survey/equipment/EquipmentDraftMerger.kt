...
class EquipmentDraftMerger : VerificationObjectDraftMerger<EquipmentSurveyDraft> {
    override fun invoke(
        ...
        return verificationObjectWithSurvey.copy(
            verificationObject = verificationObjectWithSurvey.verificationObject.copy(
                survey = treatmentSurvey.copy(equipmentSurvey = draft.equipment)
            ),
            checkedSurvey = treatmentCheckedSurvey.copy(equipmentCheckedSurvey = draft.checkedEquipment)
        )
    }
}
