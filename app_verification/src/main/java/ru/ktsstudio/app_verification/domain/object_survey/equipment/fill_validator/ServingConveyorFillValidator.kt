 ...
 */
class ServingConveyorFillValidator @Inject constructor(
...
) : FillValidator<ServingConveyor> {
    override fun isFilled(entity: ServingConveyor): Boolean {
        return entity.id.isNotEmpty() &&
            entity.loadMechanism.isNotBlank() &&
